...
(function($) {
    ...
    const ProductSlider = {
        ...
        createCustomNavigation: function(sliderId) {
            const prevButton = `
                <a href="#${sliderId}" 
                   class="carousel-nav carousel-prev btn fg ico-md sh-md ml-n0 NoScroll bg-de swiper-button-prev-custom" 
                   role="button" 
                   rel="nofollow"
            ...
            const nextButton = `
                <a href="#${sliderId}" 
                   class="carousel-nav carousel-next btn fg ico-md sh-md mr-n0 NoScroll bg-de swiper-button-next-custom" 
                   role="button" 
                   rel="nofollow"
                   aria-label="Další">
                    <svg class="ic ic-sm" aria-hidden="true">
